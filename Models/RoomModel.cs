...
namespace HRS.Models
{
    public class RoomModel
    {
        ...
        // Helper property to serialize/deserialize amenities
        [JsonIgnore]
        public List<string> Amenities
        {
            get
            {
                ...
                try
                {
                    return JsonConvert.DeserializeObject<List<string>>(AmenitiesJson) ?? new List<string>();
                }
                catch
                {
                    return new List<string>();
            ...
            set => AmenitiesJson = JsonConvert.SerializeObject(value ?? new List<string>());
        }
        ...
        // Helper property to serialize/deserialize image URLs
        [JsonIgnore]
        public List<string> ImageUrls
        {
            get
            {
                ...
                try
                {
                    return JsonConvert.DeserializeObject<List<string>>(ImageUrlsJson) ?? new List<string>();
                }
                catch
                {
                    return new List<string>();
            ...
            set => ImageUrlsJson = JsonConvert.SerializeObject(value ?? new List<string>());
        }
